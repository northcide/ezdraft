...
<div id="app">
  ...
  <div id="draft-bar" class="draft-bar">
    ...
    <div id="board-controls-bar" class="draft-bar-right admin-only hidden">
      <button id="btn-primary"      class="btn btn-vcr btn-success" disabled title="Start">&#9654;</button>
      ...
      <button id="btn-end"          class="btn btn-vcr btn-danger"  disabled title="End draft">&#9632;</button>
